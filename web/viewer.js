...
/* globals PDFJS, PDFBug, FirefoxCom, Stats, Cache, PDFFindBar, CustomStyle,
           ...
           PresentationMode, HandTool, Promise, DocumentProperties, VerifySignature,
...
var PDFView = {
  ...
  initialize: function pdfViewInitialize() {
    ...
    SecondaryToolbar.initialize({
      ...
      verifySigButton: document.getElementById('verifySig'),
    ...
    VerifySignature.initialize({
      overlayName: 'verifySignOverlay',
      closeButton: document.getElementById('documentPropertiesClose'),
      certificationField: document.getElementById('certificationField'),
      signatureField: document.getElementById('signatureField'),
      finalField: document.getElementById('finalField')
    });
...
//#endif
  ...
  load: function pdfViewLoad(pdfDocument, scale) {
    ...
    VerifySignature.resolveDataAvailable();
